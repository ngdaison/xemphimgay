...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen bg-background flex items-center justify-center p-6 font-['Be_Vietnam_Pro'] relative overflow-hidden">
      ...
      <div className="absolute top-[-10%] left-[-10%] w-[40%] h-[40%] bg-primary-container/20 blur-[120px] rounded-full animate-pulse" />
      ...
      <div className="w-full max-w-[440px] relative z-10 animate-in fade-in zoom-in duration-500">
        <div className="bg-surface-container/40 backdrop-blur-3xl border border-outline/10 rounded-[40px] p-10 md:p-12 shadow-2xl">
          <div className="text-center mb-10 space-y-2">
             ...
             <h1 className="text-3xl font-black uppercase italic tracking-tighter text-on-surface">CineStream</h1>
             <p className="text-on-surface/40 font-bold uppercase tracking-widest text-[10px]">Đăng nhập vào hành trình của bạn</p>
          </div>

          {error && (
            <div className="bg-red-500/10 border border-red-500/20 p-4 rounded-2xl mb-6 text-red-500 text-xs font-bold text-center animate-in slide-in-from-top duration-300">
              {error}
            </div>
          )}
          ...
          <form onSubmit={handleLogin} className="space-y-6">
            ...
            <div className="space-y-2">
              <div className="flex justify-between items-center px-4">
                <label className="text-[10px] font-black uppercase tracking-widest text-on-surface/40">Password</label>
                <Link href="#" className="text-[10px] font-black uppercase tracking-widest text-primary-container hover:underline">Quên mật khẩu?</Link>
              </div>
              <div className="relative group">
          ...
          <div className="mt-10 pt-10 border-t border-outline/10 text-center">
             <p className="text-on-surface/40 text-xs font-bold uppercase tracking-widest">
                Chưa có tài khoản? {" "}
                <Link href="/auth/register" className="text-primary-container hover:underline">Đăng ký ngay</Link>
             </p>
          </div>
        </div>
        
        <p className="text-center mt-8 text-[10px] font-black uppercase tracking-[0.4em] text-on-surface/20">
